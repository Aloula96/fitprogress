 ...
 */
final class Version20250912134229 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649667D1AFE FOREIGN KEY (goal_id) REFERENCES goal (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
